          ...
          <div className="learning-form-overlay">
            <div className="learning-form">
              <div className="learning-form-header">
                <h2 className="learning-form-title">
                  Create New Learning Post
                </h2>
                <p className="learning-form-subtitle">
              ...
              <form onSubmit={handleAddPost} className="learning-form-content">
                ...
                <div className="learning-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewPost({ ...newPost, contentURL: e.target.value })
                    }
                    placeholder="Enter content URL (YouTube, article, etc.)"
                  />
                  <small className="learning-input-help">
                  ...
                  >
                    {isSubmitting ? (
                      <>
                        <Loader
                          size={18}
                          className="learning-loading-spinner"
                        />
                        <span>Creating...</span>
                      </>
                    ) : (
                ...
                <article key={post.id} className="learning-card">
                  <header className="learning-card-header">
                    <div className="learning-author">
                      <div className="learning-avatar">
                        {post.postOwnerName
                          ? post.postOwnerName.charAt(0).toUpperCase()
                          : "U"}
                      </div>
                      <div className="learning-author-info">
                        <div className="learning-author-name">
                          {post.postOwnerName}
                        </div>
                  ...
                  <footer className="learning-card-footer">
                    <button
                      ...
                      className={`learning-like-btn ${
                        post.likes?.[userId] ? "liked" : ""
                      }`}
                      aria-label={
                        post.likes?.[userId] ? "Unlike post" : "Like post"
                      }
                    >
                      <ThumbsUp size={18} />
                      <span>
