            ...
            {filteredData.length === 0 ? (
              ...
              filteredData.map((progress) => (
                <div key={progress.id} className="post_card">
                  ...
                  <p className="topic_cont">
                    {progress.skillTitle}{" "}
                    <span className="topic_cont_b">{progress.field} </span>
                    <span className="topic_cont_b">{progress.level}%</span>
                  </p>
                  ...
                  <div className="date_card">
                    <p className="date_card_dte">
                      <HiCalendarDateRange /> {progress.startDate} to{" "}
                      {progress.endDate}
                    </p>
                  </div>
                  <p></p>
